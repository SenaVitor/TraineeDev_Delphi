...
begin
  ...
  begin
    Msg := 'Saldo Insuficiente, seu saldo atual é de: ' + FloatToStr(Saldo);
  end;
end;
...
begin
  ...
  begin
    Msg := 'O limite para saques na conta corrente é de 1000 reais';
  end;
end;
...
begin
  ...
  begin
    Msg := 'O valor mínimo para depósitos na conta poupança é de 200 reais';
  end;
end;
...
begin
  ...
  begin
    Msg := 'O limite para saques na conta poupança é de 500 reais';
  end;
end;
